...
@livewire('admin.notifications')
              ...
              <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                  <div class="u-info me-2">
                      <p class="mb-0 text-end line-height-sm "><span class="font-weight-bold">{{ Str::ucfirst(auth()->user()->full_name) }}</span></p>
                      <small>Admin</small>
                  </div>
                  <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                      <img class="avatar lg rounded-circle img-thumbnail" 
                      src="https://eu.ui-avatars.com/api/?background=random&amp;name={{ Str::ucfirst(auth()->user()->full_name) }}" alt="profile">
                  </a>
                  <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                      <div class="card border-0 w280">
                          <div class="card-body pb-0">
                              <div class="d-flex py-1">
                                  <img class="avatar rounded-circle" src="https://eu.ui-avatars.com/api/?background=random&amp;name={{ Str::ucfirst(auth()->user()->full_name) }}" alt="profile">
                                  <div class="flex-fill ms-3">
                                      <p class="mb-0"><span class="font-weight-bold">{{ Str::ucfirst(auth()->user()->full_name) }}</span></p>
                          ...
                          <div class="list-group m-2 ">
                              <a href="/orders" class="list-group-item list-group-item-action border-0 "><i class="icofont-file-text fs-5 me-3"></i>Order Invoices</a>
          ...
          <div class="order-0 col-lg-4 col-md-4 col-sm-12 col-12 mb-3 mb-md-0 ">
            <h6 class="mb-0 fw-bold invisible">Customer Order</h6>
          </div>
