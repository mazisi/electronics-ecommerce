      ...
      <div class="col-xs-12 col-sm-3 col-md-2 sidebar"> 
        ...
        <div class="side-menu side-menu-inner animate-dropdown outer-bottom-xs">
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
             <li class="menu-item"> <a href="#">On Sale!  <span>7584</span></a></li>
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Clothing</a>
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Electronics</a> 
                <!-- ================================== MEGAMENU VERTICAL ================================== -->
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Shoes</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-sm-12 col-md-3">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Watches</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-lg-4">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Jewellery</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-sm-12 col-md-3">
              ...
              <li class="menu-item"> <a href="#">Health and Beauty</a> </li>
              <!-- /.menu-item -->
              
                   <li class="menu-item"> <a href="#">Books</a> </li>
              
              <li class="menu-item"> <a href="#">Kids and Babies</a></li>
              <!-- /.menu-item -->
              
              <li class="menu-item"> <a href="#">Sports</a></li>
              <!-- /.menu-item -->
              
              <li class="menu-item"> <a href="#">Fruit & Veg</a></li>
              <!-- /.menu-item -->
              
              <li class="menu-item"> <a href="#">Home and Garden</a> </li>
              <!-- /.menu-item -->
      ...
      <div class="col-xs-12 col-sm-12 col-md-12"> 
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-3.png" alt=""> 
                             </a>
              ...
              <div class="products">
               ...
               <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-10.png" alt=""> 
                             </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-14.png" alt=""> 
                             </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-6.png" alt=""> 
                             </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-5.png" alt=""> 
                              </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-7.png" alt=""> 
                             </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-8.png" alt=""> 
                             </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-9.png" alt=""> 
                             </a>
            ...
            <div class="item item-carousel">
              ...
              <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-2.png" alt=""> 
                             </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-11.png" alt=""> 
                             </a>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                          <a href="#">
                             <img src="assets/images/brands/store-12.png" alt=""> 
                             </a>
        ...
        <div class="wide-banners wow fadeInUp outer-bottom-bs">
          <div class="row">
            <div class="col-md-12">
              <div class="cnt-strip">
                <div class="image1"> <img class="img-responsive" src="assets/images/banners/home-banner.jpg" alt=""> </div>
            ...
            <div class="item item-carousel">
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                     <img class="img-responsive" src="assets/images/coupons/img2.jpg" alt="">
                    <div class="brand">Marazzo</div>
            ...
            <div class="item item-carousel">
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                     <img class="img-responsive" src="assets/images/coupons/img3.jpg" alt="">
                    <div class="brand">Qualis</div>
              ...
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> 
                     <img class="img-responsive" src="assets/images/coupons/img4.jpg" alt="">
                    <div class="brand">Harrier</div>
